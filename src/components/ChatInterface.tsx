...
import { ChatInterfaceProps } from "../types/cv.types";
        ...
        <div className="fixed bottom-24 right-4 md:right-6 w-[340px] md:w-96 h-[460px] md:h-[500px] bg-white rounded-lg shadow-2xl border flex flex-col z-40">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 mt-8">
                ...
                <p className="text-xs mt-2">
                  Essayez : "Change la couleur en bleu" ou "Reformule mon
                  expérience"
                </p>
              </div>
            )}
            ...
            {messages.map((message) => (
              ...
              >
                <div
                  className={`flex items-start space-x-2 max-w-xs ${message.isUser ? "flex-row-reverse space-x-reverse" : ""}`}
                >
                  {/* Avatar */}
                  <div
